...
// NewContextWithRenderer sets the renderer to the context.
func NewContextWithRenderer(ctx context.Context, rndr *render.Render) context.Context {
	return context.WithValue(ctx, contextRenderer, rndr)
}
